...
export default function BookCard({ book }) {
    return (
        <div className="bg-white shadow-md rounded-lg d-flex flex-column justify-content-between rounded pt-3 pb-5 flex-fill w-25">
            ...
            {book.imageLinks?.thumbnail ? (
                <img src={book.imageLinks.thumbnail} alt={book.title} className='w-50 mx-auto'/>
            ) : (
